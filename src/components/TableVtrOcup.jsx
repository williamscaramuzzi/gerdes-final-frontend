...
import { COLUMNS } from './vtrscolumns';

import './TableVtrOcup.css';

export default function ViaturasOcupadas() {    
    const [conteudo, setConteudo] = useState([]);
    async function buscar(){
        let retorno = await fetch("http://localhost:3000/equipes/ocupada");
    ...
    return (
        <table id="vtrsOcupadasTable"  {...getTableProps()}>
            <thead>
                {
